...
<%--第一节--%>
<c:set var="listDetail" value="conductorDetailCharpter6_1.jsp" scope="page"/>
...
<%--第二节--%>
<c:set var="listDetail" value="conductorDetailCharpter6_2.jsp" scope="page"/>
<c:set var="listDetailImg" value="/images/conductor/charpter6/charpter6_2/6_2_1.jpg"
       scope="page"/>
...
<%@include file="/content/componet/listMoudle.jsp"%>
<%--第三节--%>
<c:set var="listDetail" value="conductorDetailCharpter6_3.jsp" scope="page"/>
<c:set var="listDetailImg" value="/images/conductor/charpter6/charpter6_3/6_3_2.jpg"
       scope="page"/>
...
<%@include file="/content/componet/listMoudle.jsp"%>
<%--第四节--%>
<c:set var="listDetail" value="conductorDetailCharpter6_4.jsp" scope="page"/>
<c:set var="listDetailImg" value="/images/conductor/charpter6/charpter6_4/6_4_1.jpg"
       scope="page"/>
...
<%@include file="/content/componet/listMoudle.jsp"%>
<%--第五节--%>
<c:set var="listDetail" value="conductorDetailCharpter6_5.jsp" scope="page"/>
<c:set var="listDetailImg" value="/images/conductor/charpter6/charpter6_5/6_5_1.jpg"
       scope="page"/>
...
<%--第六节--%>
<c:set var="listDetail" value="conductorDetailCharpter6_6.jsp" scope="page"/>
<c:set var="listDetailImg" value="/images/conductor/charpter6/charpter6_6/6_6_1.jpg" scope="page"/>
...
<%--第七节--%>
<c:set var="listDetail" value="conductorDetailCharpter6_7.jsp" scope="page"/>
<c:set var="listDetailImg" value="/images/conductor/charpter6/charpter6_7/6_7_1.jpg"
       scope="page"/>
...
<%--第八节--%>
<c:set var="listDetail" value="conductorDetailCharpter6_8.jsp" scope="page"/>
<c:set var="listDetailImg" value="/images/conductor/charpter6/charpter6_8/6_8_1.jpg"
       scope="page"/>
