...
<%--金属探测仪--%>
<c:set var="title" value="金属探测仪" scope="page" />
<c:set var="content"
       value="
用于安检查危。
"
       scope="page" />
<%@include file="/content/componet/titleAndContent.jsp" %>
<c:set var="imgPath" value="/images/conductor/charpter9/9_4.jpg" scope="page" />
<c:set var="imgSummary" value="金属探测仪" scope="page" />
<%@include file="/content/componet/imageMoudle.jsp" %>
