...
<%--步骤1--%>
<c:set var="title" value="实例—移交误乘旅客" scope="page" />
<c:set var="content"
       value="
G1805次列车<mark>蚌埠南</mark>站开车后，乘务员验票发现旅客张三，身份证号码31023019611124755X， 持<mark>蚌埠南</mark>站至<mark>合肥</mark>站的<mark>G261</mark>次车票，票号<mark>E080888</mark>，经确认，系进站后自己误乘同站台的G1805次列车，请开具客运记录。
"
       scope="page" />
<%@include file="/content/componet/demon.jsp" %>

<c:set var="reason" value="移交误乘旅客" scope="page" />
<c:set var="station" value="南京南" scope="page" />
<c:set var="name" value="G1805" scope="page" />
<c:set var="content"
       value="
 许昌东站开G1808次列车蚌埠南站开车后，验票时发现旅客张三，身份证号码31023019611124755X，持蚌埠南站至合肥站的G261次车票，票号E080888，误乘本次列车
"
       scope="page" />
...
<c:set var="imgPath"
       value="/images/conductorknowledge/passengerrecoreds/prcontent3/1.png"
       scope="page" />
<c:set var="imgSummary" value="移交误乘旅客" scope="page" />
